        ...
        <div className="bg-white/90 backdrop-blur-md rounded-3xl shadow-2xl p-8 border border-white/20">
          ...
          <div className="fade-in">
            <button
              ...
              className="w-full flex items-center justify-center space-x-3 bg-white border-2 border-gray-300 hover:border-gray-400 hover:shadow-lg text-gray-700 font-bold py-3 rounded-xl transition-all duration-200 transform hover:-translate-y-0.5"
            >
